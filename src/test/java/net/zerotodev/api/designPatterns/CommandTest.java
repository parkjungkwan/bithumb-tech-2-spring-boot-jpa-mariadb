...
public class CommandTest {
    class Aircon{
        void turnOn(){System.out.println("에어콘 켜기"); }
        void turnOff(){System.out.println("에어콘 끄기"); }
        void increaseTemp(){System.out.println("온도 올리기"); }
        void decreaseTemp(){System.out.println("온도 내리기");}
    }
